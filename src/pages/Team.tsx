import { Github, Linkedin, Mail, User, Users, Globe, Star, Award, Code2, Leaf, Zap, BookOpen, TrendingUp, Plane, Lightbulb, Heart, Dumbbell, BarChart3, Cloud } from 'lucide-react';
    ...
    const leadership = [
        {
            ...
            initials: 'PS',
            gradient: 'from-lime-500 to-green-600',
            bio: 'Leading Sai Gayatri Greentech\'s R&D division since 2014, Dr. Sharma holds 12 patents in battery storage and smart grid management. Former researcher at IIT Hyderabad.',
        ...
        },
        {
            ...
            bio: 'Kiran brings 18 years of large-scale infrastructure deployment experience. He has overseen 200+ MW project deliveries across South India.',
            expertise: ['Project Management', 'Supply Chain', 'Operations'],
        },
        {
            name: 'Sushma Reddy',
            ...
            bio: 'Expert in renewable energy project financing. Sushma has structured over ₹500 Cr in green infrastructure finance since joining Sai Gayatri Greentech.',
            expertise: ['Green Finance', 'Project Accounting', 'Tax Credits'],
        },
        {
            name: 'Ravi Nair',
            ...
            initials: 'RN',
            gradient: 'from-lime-500 to-green-600',
            bio: 'Ravi leads a global engineering team that designs and commissions Sai Gayatri Greentech\'s most complex micro-grid installations.',
        ...
        },
        {
            ...
            initials: 'AR',
            gradient: 'from-lime-400 to-green-500',
            bio: 'Expert in environmental science. Dr. Rao architects Sai Gayatri Greentech\'s ESG reporting framework, focused on carbon-neutral industrial transitions.',
        ...
        },
        {
            ...
            bio: 'Vikram has closed over ₹200 Cr in enterprise renewable energy contracts. He leads our growth strategy across the commercial and industrial sectors.',
    ...
    const engineers = [
        {
            ...
            badge: 'Engineering',
            icon: <Code2 size={12} />,
            bio: 'Prince Kumar is the lead developer behind Sai Gayatri Greentech\'s digital platforms — including this very website, the Sai Gayatri Greentech client portal, and the real-time monitoring dashboard. With deep expertise in React, TypeScript, and cloud architecture, Prince has transformed how Sai Gayatri Greentech communicates its impact to the world.',
            expertise: ['React / TypeScript', 'Node.js / APIs', 'Cloud Infrastructure', 'UI/UX Design'],
            social: { github: 'https://github.com', linkedin: '#', mail: 'prince@gmail.com' },
        ...
        },
        {
            ...
            bio: 'Ananya architects the data pipelines that power Sai Gayatri Greentech\'s real-time monitoring systems. Her work enables clients to see live energy generation data from their installations worldwide.',
            expertise: ['Python / Pandas', 'Apache Kafka', 'Power BI', 'SQL'],
            social: { github: '#', linkedin: '#', mail: 'ananya@gmail.com' },
            funFact: 'Processes over 50 million data points per day from Sai Gayatri Greentech\'s global sensor network.',
        },
        {
            ...
            badge: 'Cloud Systems',
            icon: <Cloud size={12} />,
            bio: 'Lucas maintains the cloud infrastructure that keeps Sai Gayatri Greentech\'s monitoring systems online with 99.99% uptime. He designed the CI/CD pipeline that allows the engineering team to ship updates in minutes.',
            expertise: ['AWS / GCP', 'Kubernetes', 'Terraform', 'CI/CD'],
            social: { github: '#', linkedin: '#', mail: 'lucas@gmail.com' },
            funFact: "Reduced Sai Gayatri Greentech's cloud infrastructure costs by 40% through a year-long optimization initiative.",
        },
    ];

    const departments = [
        { icon: <User size={20} />, name: 'Engineering', count: '120+ engineers', color: 'lime' },
        { icon: <User size={20} />, name: 'Technology', count: '35 developers', color: 'green' },
        { icon: <User size={20} />, name: 'Business Dev', count: '60 specialists', color: 'lime' },
        { icon: <User size={20} />, name: 'Operations', count: '85 managers', color: 'green' },
        { icon: <User size={20} />, name: 'Sustainability', count: '25 experts', color: 'lime' },
        { icon: <User size={20} />, name: 'People & Culture', count: '20 professionals', color: 'green' },
    ];
    ...
    return (
        <div className="w-full flex flex-col pt-4 pb-24">
            <SEO
                ...
                description="Meet the engineers, visionaries, and experts driving Sai Gayatri Greentech's mission."
            />
            {/* HERO SECTION */}
            <section className="relative bg-[#0d1a04] text-white py-28 overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-lime-500/10 blur-[120px] rounded-full pointer-events-none" />
                <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-green-500/10 blur-[100px] rounded-full pointer-events-none" />

                <div className="relative z-10 px-4 md:px-8 max-w-5xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-500/20 border border-lime-500/40 text-lime-300 text-sm font-bold uppercase tracking-widest mb-8">
                        <Users size={14} /> The People Behind the Power
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6">
                        Meet the <span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-green-300">Team</span>
                    </h1>
            ...
            <section className="px-4 md:px-8 max-w-7xl mx-auto w-full">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-black text-[#1a2e05] mb-3">Our Departments</h2>
                    <p className="text-slate-600">A multidisciplinary team working in perfect harmony.</p>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    {departments.map((d, i) => (
                        <div key={i} className={`frozen-glass rounded-2xl p-5 border border-white/60 text-center hover:-translate-y-1 transition-all shadow-sm hover:shadow-lg`}>
                            ...
                            <p className="font-bold text-[#1a2e05] text-sm">{d.name}</p>
                            <p className="text-xs text-slate-500 mt-1">{d.count}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="bg-white/40 py-24 border-y border-white/50">
                <div className="px-4 md:px-8 max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black text-[#1a2e05] mb-4">Our Founder</h2>
                        <p className="text-slate-600 text-lg">The visionary who started it all — from a university lab to a global energy company.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
                        ...
                        <div className="lg:col-span-2">
                            <div className="frozen-glass rounded-3xl p-8 border border-white/70 shadow-xl text-center relative overflow-hidden">
                                ...
                                <div className={`w-32 h-32 bg-gradient-to-br ${founder.gradient} rounded-3xl flex items-center justify-center text-white text-4xl font-black mx-auto mb-6 shadow-2xl shadow-lime-500/30`}>
                                    {founder.initials}
                                </div>
                                <div className="inline-flex items-center gap-1 px-3 py-1 bg-lime-100 text-lime-700 rounded-full text-xs font-bold mb-4">
                                    {founder.badge}
                                </div>
                                <h3 className="text-2xl font-black text-[#1a2e05] mb-1">{founder.name}</h3>
                                <p className="text-lime-600 font-bold text-sm mb-6">{founder.role}</p>
                                ...
                                <div className="mt-6 space-y-2">
                                    {founder.achievements.map((a, i) => (
                                        <div key={i} className="flex items-center gap-2 text-left bg-white/60 rounded-xl px-3 py-2 text-xs font-medium text-slate-700 border border-white/80">
                                            <Award size={12} className="text-lime-500 shrink-0" />
                                            {a}
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            <blockquote className="border-l-4 border-lime-500 pl-6 py-2">
                                <p className="text-xl font-medium italic text-[#1a2e05] leading-relaxed">{founder.quote}</p>
                            </blockquote>
                            ...
                            <div className="bg-gradient-to-r from-lime-50 to-green-50 rounded-2xl p-6 border border-lime-100 mt-4">
                                <h4 className="font-bold text-[#1a2e05] mb-3 flex items-center gap-2">
            ...
            <section className="px-4 md:px-8 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black text-[#1a2e05] mb-4">Executive Leadership</h2>
                    <p className="text-slate-600 text-lg max-w-2xl mx-auto">Our leadership team brings together decades of expertise in engineering, finance, operations, and sustainability.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {leadership.map((l, i) => (
                        <div key={i} className="frozen-glass rounded-3xl p-8 border border-white/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
                            ...
                            <h3 className="text-xl font-black text-[#1a2e05] mb-1">{l.name}</h3>
                            <p className="text-lime-600 font-bold text-sm mb-4">{l.role}</p>
                            <p className="text-slate-500 text-sm leading-relaxed mb-5">{l.bio}</p>
            ...
            <section className="bg-[#0f1a05] py-24 text-white relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-lime-500/5 blur-[140px] rounded-full" />
                <div className="relative z-10 px-4 md:px-8 max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-lime-500/20 border border-lime-500/30 text-lime-300 rounded-full text-xs font-bold uppercase tracking-widest mb-6">
                            <Code2 size={14} /> Technology Team
                        </div>
                        <h2 className="text-4xl font-black mb-4">The Digital Engineers</h2>
                        <p className="text-slate-300 text-lg max-w-2xl mx-auto">The team that builds the software, platforms, and digital infrastructure powering Sai Gayatri Greentech's global operations.</p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        {engineers.map((eng, i) => (
                            <div key={i} className={`relative rounded-3xl p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-all hover:-translate-y-1 ${i === 0 ? 'ring-2 ring-lime-500/30' : ''}`}>
                                {i === 0 && (
                                    <div className="absolute top-4 right-4">
                                        <span className="bg-lime-500/30 border border-lime-500/40 text-lime-300 text-xs font-bold px-3 py-1 rounded-full">Lead Dev</span>
                                    </div>
                                )}
                                ...
                                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/10 text-slate-300 rounded-full text-[10px] font-bold mb-3 border border-white/10">
                                    {eng.icon} {eng.badge}
                                </div>
                                <h3 className="text-xl font-black mb-1">{eng.name}</h3>
                                <p className="text-lime-400 font-bold text-sm mb-4">{eng.role}</p>
            ...
            <section className="px-4 md:px-8 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black text-[#1a2e05] mb-4">Life at Sai Gayatri Greentech</h2>
                    <p className="text-slate-600 text-lg max-w-2xl mx-auto">We work hard on problems that matter — and we build a culture that makes extraordinary work possible.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={i} className="frozen-glass rounded-2xl p-6 border border-white/60 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all text-center">
                            <div className="flex justify-center text-lime-500 mb-4">{perk.icon}</div>
                            <h4 className="font-bold text-[#1a2e05] mb-2">{perk.title}</h4>
            ...
            <section className="px-4 md:px-8 max-w-4xl mx-auto text-center">
                <div className="bg-gradient-to-br from-lime-500 to-green-600 rounded-3xl p-12 md:p-16 shadow-2xl shadow-lime-500/20 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lime-50 text-lg mb-8 max-w-xl mx-auto">We're always looking for exceptional engineers, scientists, and business leaders passionate about clean energy. Come build the future with us.</p>
                        <div className="flex flex-wrap gap-4 justify-center">
                            <Link to="/contact">
                                <button className="bg-white text-[#1a2e05] px-8 py-4 rounded-2xl font-black hover:scale-105 transition-all shadow-xl">
                                    View Open Roles
                                </button>
                            </Link>
                            <Link to="/about">
